...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InputBinding) DeepCopyInto(out *InputBinding) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputBinding.
func (in *InputBinding) DeepCopy() *InputBinding {
	if in == nil {
		return nil
	}
	out := new(InputBinding)
	in.DeepCopyInto(out)
	return out
}
