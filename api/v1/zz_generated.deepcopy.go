...
func (in *InputRevisions) DeepCopyInto(out *InputRevisions) {
	*out = *in
	...
	if in.IgnoreSideEffects != nil {
		in, out := &in.IgnoreSideEffects, &out.IgnoreSideEffects
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TombstoneRecoveryStatus) DeepCopyInto(out *TombstoneRecoveryStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TombstoneRecoveryStatus.
func (in *TombstoneRecoveryStatus) DeepCopy() *TombstoneRecoveryStatus {
	if in == nil {
		return nil
	}
	out := new(TombstoneRecoveryStatus)
...
func (in *Variation) DeepCopyInto(out *Variation) {
	*out = *in
	...
	if in.DependsOn != nil {
		in, out := &in.DependsOn, &out.DependsOn
		*out = make([]VariationDependency, len(*in))
		copy(*out, *in)
	}
}
