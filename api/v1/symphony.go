...
type Variation struct {
	...
	// Optional marks this variation as optional. Optional variations do not count against
	// the aggregated synthesis, reconciliation, and readiness statuses of the symphony.
