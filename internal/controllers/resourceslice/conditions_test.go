...
func TestProcessTransition_AllHealthy_SeedsConditions(t *testing.T) {
	...
	applied := meta.FindStatusCondition(comp.Status.CurrentSynthesis.Conditions, apiv1.ConditionResourceApplied)
	...
	ready := meta.FindStatusCondition(comp.Status.CurrentSynthesis.Conditions, apiv1.ConditionResourceReady)
...
func TestConditionMatches(t *testing.T) {
	withCond := func(status metav1.ConditionStatus, msg string) *apiv1.Composition {
		...
		c.Status.CurrentSynthesis = &apiv1.Synthesis{
			Conditions: []metav1.Condition{
				{Type: apiv1.ConditionResourceApplied, Status: status, Message: msg},
			},
		}
		return c
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, conditionMatches(tt.comp, apiv1.ConditionResourceApplied, tt.wantTrue, tt.wantMsg))
		})
	}
}
...
func TestProcessTransition_SeedsOnFirstReconcile(t *testing.T) {
	...
	require.NotNil(t, meta.FindStatusCondition(comp.Status.CurrentSynthesis.Conditions, apiv1.ConditionResourceApplied))
	require.NotNil(t, meta.FindStatusCondition(comp.Status.CurrentSynthesis.Conditions, apiv1.ConditionResourceReady))
...
func TestProcessTransition_FalseEmptyMessageDistinct(t *testing.T) {
	...
	comp.Status.CurrentSynthesis = &apiv1.Synthesis{
		...
		Conditions: []metav1.Condition{{
			Type:   apiv1.ConditionResourceApplied,
...
// reconcileWithSlice is a small helper to set up a composition with one slice
