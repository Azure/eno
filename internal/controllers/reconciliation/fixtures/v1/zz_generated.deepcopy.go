...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestValue) DeepCopyInto(out *TestValue) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestValue.
func (in *TestValue) DeepCopy() *TestValue {
	if in == nil {
		return nil
	}
	out := new(TestValue)
