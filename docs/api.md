...
| `synthesisEnv` _[EnvVar](#envvar) array_ | SynthesisEnv<br />A set of environment variables that will be made available inside the synthesis Pod. |  |  |
...
| `synthesisEnv` _[EnvVar](#envvar) array_ | SynthesisEnv<br />Copied opaquely into the compositions managed by this symphony. |  |  |
