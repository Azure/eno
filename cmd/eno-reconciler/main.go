...
func run() error {
	...
	flag.BoolVar(&recOpts.DisableReconciliationCheck, "optimistic", false, "Report that resources are reconciled once they've been seen, even if reconciliation failed. Useful in some cases where Eno deploys its own reconcilers.")
